...
// The MenuReviewFunc type is an adapter to allow the use of ordinary
// function as MenuReview mutator.
type MenuReviewFunc func(context.Context, *ent.MenuReviewMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f MenuReviewFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.MenuReviewMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.MenuReviewMutation", m)
}
...
// The StoreReviewFunc type is an adapter to allow the use of ordinary
// function as StoreReview mutator.
type StoreReviewFunc func(context.Context, *ent.StoreReviewMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f StoreReviewFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.StoreReviewMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.StoreReviewMutation", m)
}
